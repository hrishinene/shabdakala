...
export const BaseModal = ({ title, children, isOpen, handleClose }: Props) => {
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-10 inset-0 overflow-y-auto flex items-center justify-end" // Changed justify-center to justify-end for right alignment
        onClose={handleClose}
      >
        <div className="flex items-center justify-end min-h-screen py-10 px-4 text-center sm:block sm:p-0"> {/* Align right */}
          <Transition.Child
            as={Fragment}
