...
def update_final_tuples_list(csv_file_path: str, ts_file_path: str, ind: int = None):
    """
    Process a CSV file to extract tuples, mark its statys, and update the FinalTuplesList in a TypeScript file.
    ...
    #Step-3 : update status in .csv file
    df.to_csv(csv_file_path, index=False)   


    # Step-4 : update .ts file with FinalTuplesList
